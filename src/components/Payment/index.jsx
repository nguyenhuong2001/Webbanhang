...
function Payment() {
    const [Listproduct,setListproduct]=useState(JSON.parse(localStorage.getItem('ListProduct'))? JSON.parse(localStorage.getItem('ListProduct')) :[])
